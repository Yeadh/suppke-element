...
class suppke {
	...
	public function suppke_setup() {
		add_image_size( 'suppke-77x64', 77,64, true );
		add_image_size( 'suppke-100x75', 100,75, true );
	}
	...
	public function admin_scripts() {
	    wp_enqueue_media();
	    wp_enqueue_script('suppke-admin-main-js', plugin_dir_url( __FILE__ ) . 'admin/assets/js/main.js', array('jquery'), wp_get_theme()->get( 'Version' ), true );
	}
